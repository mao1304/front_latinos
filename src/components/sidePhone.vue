<template>
    <div class="social-sidebar">
      <div class="follow-text">Call </div>
  ...
  <script setup>
  import { Facebook as FacebookIcon, Twitter as TwitterIcon, Linkedin as LinkedinIcon, Globe as GlobeIcon, Instagram as InstagramIcon } from 'lucide-vue-next'
  </script>

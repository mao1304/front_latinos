  ...
  <main>
    ...
    <section class="service-4 pos-rel mt-180 mb-130" style="overflow-x: hidden; ">
      ...
      <div class="services-inner pos-rel">
        <div class="services-bg bg_img" :style="{ backgroundImage: `url('/img/reales/FOTOGRAFIAS/about-1.jpg')` }">
        </div>
            ...
            <div v-for="service in services" :key="service.id" class="swiper-slide  dm-service">
              ...
              <div class="xb-item--image">
                <img :src="service.img" alt=""
                  style="height: 324px; width: 315px; object-fit: cover; object-position: center" />
              </div>
              <div class="xb-item--srv_link">
                <router-link :to="service.link">Conoce más <span><img src="/img/digital-marketing/icon/dm-srv.png"
